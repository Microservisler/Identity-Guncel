...
using Project5.STS.Identity.Configuration;
using Project5.STS.Identity.Configuration.ApplicationParts;
using Project5.STS.Identity.Configuration.Constants;
using Project5.STS.Identity.Configuration.Interfaces;
using Project5.STS.Identity.Helpers.Localization;
...
namespace Project5.STS.Identity.Helpers
{
